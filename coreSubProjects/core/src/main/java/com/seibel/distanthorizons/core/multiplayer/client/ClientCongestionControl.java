...
{
	/** Rate increase per second when throughput is good (200 KB/s) */
	private static final double ADDITIVE_INCREASE = 200000;
	/** Initial starting rate (500 KB/s) - reasonable for both WiFi and ethernet */
	private static final double INITIAL_RATE = 500000;
