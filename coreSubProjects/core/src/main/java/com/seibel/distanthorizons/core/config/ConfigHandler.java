...
public class ConfigHandler
{
	...
	private void runFirstTimeSetup()
	{
		...
		// Revalidate thread config for this machine's CPU cores
		// This ensures configs transferred from machines with different core counts work correctly
		ThreadPresetConfigEventHandler.INSTANCE.revalidateForCurrentMachine();
