...
public class ClientLevelWrapper implements IClientLevelWrapper
{
	...
	public IChunkWrapper tryGetChunk(DhChunkPos pos)
	{
		...
		// Skip DH heightmap recreation - chunks returned here are always complete
		// (either pre-existing from disk or fully generated by MC) and have valid MC heightmaps.
